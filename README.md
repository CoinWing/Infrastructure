...
| **Orderbook Service** | `8081` | 거래 주문 처리를 위한 실시간 호가 데이터 API |
| **Trading Service** | `8082` | 거래 주문 처리 API |
...
| **msa-auth-redis** | `6379` | ClusterIP | 인증용 Redis |
| **msa-trade-redis** | `6380` | ClusterIP | 거래용 Redis |
